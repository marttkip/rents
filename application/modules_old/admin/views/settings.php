          ...
          <div class="row">
            ...
            <div class="tabbable">
                ...
                <div id="myTabContent" class="tab-content">
                        ...
                        <div class="col-md-3">
                            <div class="list-group">
                                <li class="list-group-item no-padding">
                                    <img alt="" src="img/user-big.jpg">
                                </li>
                                <a class="list-group-item" href="#">Projects</a>
                        ...
                        <div class="col-md-9">
                            <div class="row profile-info">
                                <div class="col-md-7">
                                    ...
                                    <p class="margin-bottom-20">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt laoreet dolore magna aliquam tincidunt erat volutpat laoreet dolore magna aliquam tincidunt erat volutpat.</p>
                                </div>
                                <div class="col-md-5">
                                    <div class="widget">
                    ...
                    <div class="tab-pane fade" id="edit_account">
                        <div class="widget">
                            <div class="widget-head">
                                <h4 class="pull-left">General Information</h4>
                                ...
                                <div class="padd">
                                    ...
                                    <div class="form profile">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="name1">Name</label>
                                        ...
                                        <!-- Email -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="email1">Email</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- Telephone -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="telephone">Telephone</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- Address -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="address">Address</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- Country -->
                                        <div class="form-group">
                                        <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4">Country</label>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- State -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="city">State</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- City -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="city">City</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- Username -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="username2">Username</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- Password -->
                                        <div class="form-group">
                                            <label class="control-label col-lg-3 col-md-3 col-sm-3 col-xs-4" for="password2">Password</label>
                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-8">
                                        ...
                                        <!-- Buttons -->
                                        <div class="form-group f-buttons">
                                            <!-- Buttons -->
                                            <div class="btn-group">
