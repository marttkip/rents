        <section class="panel panel-featured panel-featured-info">
          ...
          <!-- Widget content -->
			...
			<?php
            echo form_open("search-defaulters/", array("class" => "form-horizontal"));
            ?>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                        	<div class="input-group">
                                ...
                                <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="payment_date_from" placeholder="Payment Date From">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                        	<div class="input-group">
                                ...
                                <input data-format="yyyy-MM-dd" type="text" data-plugin-datepicker class="form-control" name="payment_date_to" placeholder="Payment Date To">
                            </div>
                        </div>
                    </div>
