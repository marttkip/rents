												...
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
                                                        	<option value="Porto Admin" selected>Sale 1</option>
                                                            <option value="Porto Drupal" selected>Sale 2</option>
                                                            <option value="Porto Wordpress" selected>Sale 3</option>
														</select>
													</strong>
												</h2>
						...
						<div class="col-md-6">
							<section class="panel">
								<header class="panel-heading">
									...
									<h2 class="panel-title">Best Selling Dobis</h2>
