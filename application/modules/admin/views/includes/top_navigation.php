									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?php echo base_url().'assets/img/avatar.jpg';?>" alt="Avatar" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?php echo base_url().'assets/img/avatar.jpg';?>" alt="Joseph Junior" class="img-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="<?php echo base_url().'assets/img/avatar.jpg';?>" alt="Joe Junior" class="img-circle" />
												</figure>
